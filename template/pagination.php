...
<nav aria-label="...">
    <ul class="pagination justify-content-center">
        ...
        <?php for ($i = 0, $j = 1; $i < round($controller->pagination(count($x), $controller->limit)); $i++, $j++) :  ?>
        ...
        <?php endfor; ?>
        <li class="page-item ">
            <a class="page-link " href="<?php echo paginationPlus($controller, 1, round($controller->pagination(count($x), $controller->limit))); ?>">
